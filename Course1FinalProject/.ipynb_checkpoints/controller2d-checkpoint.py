...
class Controller2D(object):
    ...
    def update_controls(self):
        ...
        if self._start_control_loop:
            ...
            # https://www.coursera.org/learn/intro-self-driving-cars/discussions/weeks/7/threads/N3X_qUVUEemJ5xJ6kj-nZg/replies/Xkn5RkYeEem5Mwr7Ffj6Ag/comments/LgvI3mTmSv-LyN5k5kr_uw
            ...
            # https://devmesh.intel.com/projects/self-driving-cars-longitudinal-and-lateral-control-design#about-section
            # https://github.com/paulyehtw/Lane-Keeping-Assist-on-CARLA/blob/1d568de9623cc6729028bda50055962162e3b481/controller2d.py#L132
            # https://github.com/AtsushiSakai/PythonRobotics/blob/bb8b8b33d44d6ce3a04b2c16cd3a97fa36189abf/PathTracking/stanley_controller/stanley_controller.py#L130-L141
            ...
            #we need to have trajectory line using 
            #    slope of trajectory line
            #    waypoint_heading = tan_inv (slope of line)
            
            # heading_error = waypoint /trajectory heading - vehicle heading (i.e. yaw)
            # cross_track_error = 
            #first serach the nearest point to the trajectory line
             #   trajectory line is constructed using previous waypoint and the next waypoint 
             #   nearest 
                

            
            k_cte = 0.3 # proportial gain for cross track error
            ...
            steer_output = heading_yaw_diff + cross_track_yaw_diff
